// Keep in sync with docs/system-prompt.md. The .md file is the source of
// truth — review changes there in PRs, then mirror here. (A generator
// script may replace this hand-sync later.)
